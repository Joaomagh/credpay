...
| Implementado | 67 testes automatizados verdes, incluindo HTTP ponta a ponta e integração PostgreSQL/Testcontainers |
...
| Em validação | lock transacional por chave serializa primeiras criações concorrentes; evidência PostgreSQL segue como barreira do CI |
