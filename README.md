...
| Implementado | 74 testes automatizados verdes, incluindo HTTP ponta a ponta, integração PostgreSQL/Testcontainers e concorrência real |
...
| Documentado | baseline RabbitMQ com propriedade da topologia, confirms/returns, retry e DLQ; broker ainda não implementado |
