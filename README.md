...
| Implementado | 24 testes automatizados verdes, incluindo sucesso HTTP sem mocks |
...
| Ainda não implementado | persistência, consulta, tipos JSON estritos, RabbitMQ, `processamento-service`, containers, Kubernetes e CD |
