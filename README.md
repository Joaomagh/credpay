...
| Implementado | 77 testes automatizados verdes, incluindo HTTP ponta a ponta, PostgreSQL e RabbitMQ com Testcontainers e concorrência real |
...
| Ainda não implementado | publicador automático da outbox, consumidor, constraints de moeda/status no banco, `processamento-service`, imagem da aplicação, Kubernetes e CD |
