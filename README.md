...
| Implementado | 85 testes automatizados verdes, incluindo HTTP ponta a ponta, PostgreSQL e RabbitMQ com Testcontainers e concorrência real |
...
| Ainda não implementado | lote/scheduler da outbox, coordenação entre réplicas, consumidor, constraints de moeda/status no banco, `processamento-service`, imagem da aplicação, Kubernetes e CD |
